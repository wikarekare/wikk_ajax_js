var wikk_ajax = ( function() {
  ...
  function delayed_ajax_post_call(url, args, callback, error_callback=ajax_error, completion_callback=null, response_type='html', stringify=false, delay=180000) {
  ...
  //  @param response_type [String] The available data types are text, html (Default), xml, json, jsonp, and script
  //  @param delay [Integer] Millisecond delay before ajax call is made.
  function delayed_ajax_get_call(url,args,callback, error_callback=ajax_error, completion_callback=null, response_type='html', traditional=false, delay=180000) {
  ...
  //  @param response_type [String] The available data types are text, html (Default), xml, json, jsonp, and script
  //  @param stringify [Boolean] stringify ? JSON.stringify(args) : $.param(args)
  function ajax_post_call(url, args, callback, error_callback=ajax_error, completion_callback=null, response_type='html', stringify=false) {
  ...
  //  @param completion_callback [Function] Called when the request finishes (after success and error callbacks are executed).  Function( jqXHR jqXHR, String textStatus )
  //  @param response_type [String] The available data types are text, html (Default), xml, json, jsonp, and script
  function ajax_get_call(url, args, callback, error_callback=ajax_error, completion_callback=null, response_type='html', traditional=false) {
